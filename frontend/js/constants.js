...
const welcome_h2 = "Connect to MetaMask to get a Newt!";
const welcome_p = 'CNC is a collection of 10000 unique Newts living on the Pologon Blockchain';
...
const p_public_mint = "Feel free to join the Newts!";
